...
const CoverPage = () => (
  <section
    id="top"
    className="hero-section-bg relative w-full overflow-hidden min-h-[94vh] flex items-center"
  >
    ...
    {/* ── Animated blob orbs ── */}
    <div className="pointer-events-none absolute -left-40 top-1/4 h-[500px] w-[500px] rounded-full bg-[#1a4a82]/25 blur-[110px] animate-blob" />
    <div className="pointer-events-none absolute -right-28 top-0 h-[420px] w-[420px] rounded-full bg-sky-600/18 blur-[100px] animate-blob-delay-2" />
    <div className="pointer-events-none absolute bottom-0 left-1/3 h-[320px] w-[560px] rounded-full bg-[#0d3060]/30 blur-[90px] animate-blob-delay-4" />
    ...
    {/* ── Floating particles (hp-1 … hp-20 defined in index.css) ── */}
    {Array.from({ length: PARTICLE_COUNT }, (_, i) => (
      <span key={i} className={`pointer-events-none absolute rounded-full hp-${i + 1}`} />
    ))}
        ...
        <div>
          ...
          <div data-reveal="reveal reveal-delay-3" className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/6 px-7 py-3.5 text-sm font-heading font-semibold text-white/80 backdrop-blur-sm transition hover:bg-white/10 hover:text-white"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-emerald-500/25 bg-emerald-500/10 px-7 py-3.5 text-sm font-heading font-semibold text-emerald-300 transition hover:bg-emerald-500/20"
            >
        ...
        <div data-reveal="reveal-scale reveal-delay-2" className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              { value: "Fast", label: "Discovery to build" },
            ].map((item) => (
